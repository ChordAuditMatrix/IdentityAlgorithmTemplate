...
CryptoArray NewOfflineIdentityAlgorithm::aggregate(const AggregateRequest& /*req*/)
{
    // TODO: Implement offline signature aggregation.
    spdlog::warn("NewOfflineIdentityAlgorithm::aggregate() stub — not implemented");
    return CryptoArray{};
}
